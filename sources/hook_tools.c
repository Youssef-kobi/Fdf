...
void	draw(t_data d)
{
	mlx_string_put(d.mp, d.wp, 10, 840, 0255000000, "(i/p)change perspective");
	mlx_string_put(d.mp, d.wp, 10, 860, 0255000000, "(+/-)zoom in or out");
	mlx_string_put(d.mp, d.wp, 10, 880, 0255000000, "(r/g/b/0)change colors");
	mlx_string_put(d.mp, d.wp, 10, 900, 0255000000, "(P-up/down)change angle");
	mlx_string_put(d.mp, d.wp, 10, 920, 0255000000, "(Arrows)move draw");
